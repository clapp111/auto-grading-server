...
class ModelAnswer(Base):
    ...
    problem_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("problem.problem_id"), nullable=False, unique=True)
    ...
    problem: Mapped["Problem"] = relationship(back_populates="model_answer")
