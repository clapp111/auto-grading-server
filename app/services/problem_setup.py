...
class ProblemSetupService:
    def __init__(self, problem_repo: ProblemRepository, exam_repo: ExamRepository, storage: StorageClient):
...
def get_problem_setup_service(
    ...
    return ProblemSetupService(ProblemRepository(db), ExamRepository(db), storage)
