...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "ocr_result_answer_region_id_fkey", "ocr_result", type_="foreignkey"
    )
    op.create_foreign_key(
        "ocr_result_answer_region_id_fkey",
        "ocr_result",
        "answer_region",
        ["answer_region_id"],
        ["answer_region_id"],
    ...
    op.drop_constraint(
        "model_answer_problem_id_fkey", "model_answer", type_="foreignkey"
    )
    op.create_foreign_key(
        "model_answer_problem_id_fkey",
        "model_answer",
        "problem",
        ["problem_id"],
        ["problem_id"],
    ...
    op.drop_constraint(
        "answer_region_answer_sheet_id_fkey", "answer_region", type_="foreignkey"
    )
    op.create_foreign_key(
        "answer_region_answer_sheet_id_fkey",
        "answer_region",
        "answer_sheet",
        ["answer_sheet_id"],
        ["answer_sheet_id"],
    ...
    op.drop_constraint(
        "answer_region_problem_id_fkey", "answer_region", type_="foreignkey"
    )
    op.create_foreign_key(
        "answer_region_problem_id_fkey",
        "answer_region",
        "problem",
        ["problem_id"],
        ["problem_id"],
    ...
    op.drop_constraint(
        "answer_sheet_student_id_fkey", "answer_sheet", type_="foreignkey"
    )
    op.create_foreign_key(
        "answer_sheet_student_id_fkey",
        "answer_sheet",
        "student",
        ["student_id"],
        ["student_id"],
    ...
    op.create_foreign_key(
        "job_exam_id_fkey", "job", "exam", ["exam_id"], ["exam_id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    op.drop_constraint("job_retry_of_job_id_fkey", "job", type_="foreignkey")
    op.create_foreign_key(
        "job_retry_of_job_id_fkey", "job", "job", ["retry_of_job_id"], ["job_id"]
    )
    ...
    op.drop_constraint("job_problem_id_fkey", "job", type_="foreignkey")
    op.create_foreign_key(
        "job_problem_id_fkey", "job", "problem", ["problem_id"], ["problem_id"]
    )
    ...
    op.drop_constraint("answer_sheet_exam_id_fkey", "answer_sheet", type_="foreignkey")
    op.create_foreign_key(
        "answer_sheet_exam_id_fkey", "answer_sheet", "exam", ["exam_id"], ["exam_id"]
    )

    op.drop_constraint("student_exam_id_fkey", "student", type_="foreignkey")
    op.create_foreign_key(
        "student_exam_id_fkey", "student", "exam", ["exam_id"], ["exam_id"]
    )

    op.drop_constraint("problem_exam_id_fkey", "problem", type_="foreignkey")
    op.create_foreign_key(
        "problem_exam_id_fkey", "problem", "exam", ["exam_id"], ["exam_id"]
    )
    ...
    op.drop_constraint("rubric_problem_id_fkey", "rubric", type_="foreignkey")
    op.create_foreign_key(
        "rubric_problem_id_fkey", "rubric", "problem", ["problem_id"], ["problem_id"]
    )
    ...
    op.drop_constraint("grade_student_id_fkey", "grade", type_="foreignkey")
    op.create_foreign_key(
        "grade_student_id_fkey", "grade", "student", ["student_id"], ["student_id"]
    )

    op.drop_constraint("grade_problem_id_fkey", "grade", type_="foreignkey")
    op.create_foreign_key(
        "grade_problem_id_fkey", "grade", "problem", ["problem_id"], ["problem_id"]
    )
